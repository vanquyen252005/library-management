...
public class ConnectDB {
    ...
    public List<RequestBook> searchDocumentsDBSingleColumn(String column, String keyword) {
    ...
    public List<RequestBook> searchDocumentsDB(String keyword) {
        List<RequestBook> books = new ArrayList<>();
        String sql;
    ...
    public List<RequestBook> searchDocumentsAPI(String keyword) {
        ArrayList<RequestBook> books = new ArrayList<>();
        System.out.println("No data returned from database so trying to testing api source.");
        List<RequestBook> sample = ApiService.searchBooks(keyword);
        for(RequestBook b : sample) books.add(b);
        if(books.size() == 0) {
    ...
    public RequestBook getBookByISBN(String isbn) {
