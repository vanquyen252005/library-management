...
public class Jdbc {
    ...
    public ArrayList<BookBorrowed> loadBorrowedBook(int user_id) {
        ArrayList<BookBorrowed> listBook = new ArrayList<>();
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                book.setReturnDate(resultSet.getString("request_date"));
                listBook.add(book);
            }
